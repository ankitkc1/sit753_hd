const aboutData = {
  profile: {
    ...
    intro: "Just a human trying to make cool stuff with code and research. My world revolves around AI, research, and modern software development, where I build everything from RAG-based assistants and interactive web platforms to blockchain solutions. Beneath it all is a deep curiosity for health informatics and the future of intelligent systems in human wellbeing. I see code as more than syntax and research as more than theory - together, they become a way to design the future.",
  ...
  impact: {
    citationGrowth: 68,
    orcid: "0009-0006-8755-0081",
    areas: ["Health Informatics", "RAG Systems", "AI Development"],
  ...
  skills: [
    {
      group: "AI / ML",
      items: [
        { name: "Python", level: 88, note: "LangChain, LlamaIndex, Scikit-learn, TensorFlow, PyTorch" },
        { name: "LLMs / RAG", level: 74, note: "RAG Systems, Fine-tuning" },
        { name: "FastAPI", level: 68, note: "RESTful APIs" },
        { name: "Database / Vector Search", level: 78, note: "Vector DB,Structured + semantic retrieval" },
